...
final class SKEssentialFeedCacheIntegrationTests: XCTestCase {
    ...
    func test_load_deliversItensSavedOnASeperateInstance() throws {
    ...
    private func expect(_ sut: LocalFeedLoader, toLoad expectedFeed: [FeedImage], file: StaticString = #file, line: UInt = #line) {
        ...
        sut.load { result in
            ...
            case let .success(imageFeed):
                XCTAssertEqual(imageFeed, expectedFeed, "Expected \(expectedFeed), got \(imageFeed) instead", file: file, line: line)
